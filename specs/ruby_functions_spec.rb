...
class Functions_Practice < MiniTest::Test
  ...
  def test_length_of_string()
    ...
    l = length_of_string( "A string of length 21" )
    assert_equal( 21, l )
  end
  ...
  def test_volume_of_cube()
    volume_result = side_length_to_cube_volume(3)
  ...
  def test_volume_of_sphere()
    volume_result = radius_length_to_sphere_volume(3)
    assert_equal( 113.04, volume_result)
    #add test code here
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
  celsius_degrees = fahrenheit_to_celsius(48)
  assert_equal( 8.89, celsius_degrees)
    #add test code here
  end
